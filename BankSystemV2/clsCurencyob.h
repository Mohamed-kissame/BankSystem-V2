...
public:
    ...
    static   clsCurrency FindByCode(string CurrencyCode)
    {
        ...
        CurrencyCode = clsString::UpperAllLetterOfAStrin(CurrencyCode);
    ...
    {
        Country = clsString::UpperAllLetterOfAStrin(Country);
        ...
        if (MyFile.is_open())
        {
            ...
            {
                clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
                if (clsString::UpperAllLetterOfAStrin(Currency.Country()) == Country)
                {
                    MyFile.close();
                    return Currency;
                }
